@extends('dsh.master')
@section('title' , 'لیست قالین های وزنی')
@section('content')
  <!-- navbar -->
  <div class="row" id="list-weight">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="card hideOnPrint">
        <div class="card-header">
          <h5> پارچه های وزنی</h5>
        </div>
        <div class="card-body">
          @if(!$editCarpet)
            <form action="/dashboard/post-weight" method="post">
              @csrf
              <input type="hidden" value="{{ $AccountNo }}" name="parcha_number" id="account_no" class="form-control">
              ...
              <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                  <div class="form-group fill">
                    ...
                    <input type="date" name="date" placeholder="تاریخ شروع را وارد کنید"
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                  <div class="form-group fill">
                    ...
                    <input type="date" name="end_date" placeholder="تاریخ ختم را وارد کنید"
          ...
          @else
            <form action="/dashboard/upd-weight/{{$editCarpet->carpet_id}}" method="post">
              @csrf
              <input type="hidden" value="0" name="status" id="account_no" class="form-control">
      ...
      <div class="card">
        <div class="card-header">
          <div class="alert alert-success text-center" style="display:none;" role="alert">
            ...
            پارچه موفقانه حذف شد
          </div>
          
          @if(session("status"))
            <div class="alert alert-info status text-center" style="display:none;" role="alert">
              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
              {{session('status')}}
            </div>
          ...
          <div class="row hideOnPrint">
            ...
            <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4">
              ...
              <form action="/dashboard/search-weight-carpet-by-agent" method="POST" id="dateSearch">
                @csrf
                <div class="row">
            ...
            <div class="col-xs-2 col-lg-2 col-md-2 col-sm-2 hideOnPrint">
              <a href="/dashboard/list-weight-show-all" style="float: left" class="btn btn-sm btn-info hideOnPrint">نمایش
                همه</a>
            </div>
            <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 hideOnPrint">
              <div class="btn-group hideOnPrint" id="exportButton" style="float: left; ">
                <div class="btn btn-sm btn-primary" style="float: left" onclick="printPage('list-weight')"><i
        ...
        <div class="card-body">
          ...
          <div class="table-responsive" style="margin-top: 60px">
            <table class="table table-hover table-xs" id="weight_carpet">
              <thead>
              <tr>
                ...
                @if(isset($search))
                  @if($carpet->contract_type == 'contractional' && $carpet->status == 0)
                    <tr class="ur{{ $carpet->carpet_id }}">
                      ...
                      <td class="hideOnPrint"><a href="/dashboard/edit-weight/{{$carpet->carpet_id}}"
                      ...
                      {{--@if($carpet->status == 12)--}}
                      {{--<td class="hideOnPrint">کچایی شده</td>--}}
                      {{--@else--}}
                      ...
                      <td class="hideOnPrint"><a href="/dashboard/show-weight/{{$carpet->carpet_id}}"
                                                 class="btn btn-sm btn-info"><i
...
@section('scripts')
  ...
  <script>
      $(document).ready(function () {
                          ...
                          $.ajax({
                              ...
                              success: function (res) {
                                  ...
                                  if (res.status == 'success') {
                                      ...
                                      $('.alert-success').show();
                                      window.location = '/dashboard/list-weight'
                                  } else {
                                      $('.alert-danger').show();
                                  }
          ...
          var $buttons = $('#weight_carpet').find('caption').children().detach();
