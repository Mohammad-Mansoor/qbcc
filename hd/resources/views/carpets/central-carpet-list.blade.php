...
@section('content')
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="card" id="center-carpet">
        <div class="card-header">
          <h5>قالین های موجود در دفتر مرکزی</h5>
          <div class="btn btn-sm btn-primary hideOnPrint" style="float: left;" onclick="printPage('center-carpet')"><i
