          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="carpet-checkbook" role="tabpanel"
              ...
              <div class="btn btn-sm btn-primary hideOnPrint"
                   ...
                   onclick="printPage('check-book-details')"><i class="fa fa-print"></i> Print
              </div>
              <div class="row" id="check-book-details">
                @if (!$carpetCheckBook)
                    ...
                    <div class="all-form-element-inner">
                      <form action="/dashboard/check-book" method="post">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                            <div class="form-group fill">
                              <label class="pull-right" for="qheight">طول قبلی</label>
                              <input type="text"
                                     class="form-control" id="qheight" value="{{$carpet->height}}" readonly>
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                            <div class="form-group fill">
                              <label class="pull-right" for="qwidth">عرض قبلی</label>
                              <input type="text"
                                     class="form-control" value="{{$carpet->width}}" id="qwidth" readonly>
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                            <div class="form-group fill">
                              <label class="pull-right">طول فعلی</label>
                              <input type="text" name="height" placeholder=" طول قالین"
                                     class="form-control" id="CH" value="{{old('height')}}">
                              @error('height') <p class="text-danger">
                                {{trans('message.'.$message)}}</p>
                              @enderror
                            </div>
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                            <div class="form-group fill">
                              <label class="pull-right">عرض فعلی</label>
                              <input type="text" name="width" placeholder=" عرض قالین"
                                     class="form-control" value="{{old('width')}}" id="CW">
                              @error('width') <p class="text-danger">
                                {{trans('message.'.$message)}}</p>
                              @enderror
                            </div>
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                            <div class="form-group fill">
                              ...
                              <input type="text" name="heightwaste" placeholder="  ضایعات طول قالین "
                                     class="form-control" value="{{old('heightwaste')}}"
                                     id="heightWaste" readonly>
                              @error('heightwaste') <p class="text-danger">
                                {{trans('message.'.$message)}}</p>
                              @enderror
                            </div>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                            <div class="form-group fill">
                              ...
                              <input type="text" name="widthwaste"
                                     placeholder="  ضایعات عرض قالین" class="form-control"
                                     value="{{old('widthwaste')}}"
                                     id="widthWaste" readonly>
                              @error('widthwaste') <p class="text-danger">
                                {{trans('message.'.$message)}}</p>
                              @enderror
                            </div>
                          </div>
                ...
                @else
                  <div class="col-sm-12" id="check-book-details">
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="form-group-inner">
                              <div class="row" style=" display:flex;justify-content:space-around">
                                <div class="col-xs-5">
                                  <label class="pull-right">ضایعات طول</label>
                                  <input type="text" name="heightwaste"
                                         value="{{$carpetCheckBook->heightwaste}}"
                                         class="form-control" id="heightWaste">
                                  <input type="hidden" value="{{$carpet->id}}"
                                         name="carpetId">
                                  @error('heightwaste') <p class="text-danger">
                                    {{trans('message.'.$message)}}</p>
                                  @enderror
                                ...
                                <div class="col-xs-5">
                                  <label class="pull-right">ضایعات عرض</label>
                                  <input type="text" name="widthwaste"
                                         value="{{$carpetCheckBook->widthwaste}}"
                            ...
                            <div class="form-group-inner">
                              <div class="row"
                                   style="display:flex;justify-content:flex-start;padding:0 70px">
                                <a href="/dashboard/contract-carpet/{{$carpet->carpet_id}}"
                                   class="btn btn-white" type="reset">انصراف</a>
                                <button class="btn btn-primary marginx" type="submit">
                  ...
                  <div class="sparkline8-graph text-muted">
                    ...
                    <div class="static-table-list">
                      <table class="table text-center">
                        ...
                        @endforelse
                        <tr>
                          <th>مجموع پول افغانی</th>
                          <td style="direction: ltr"> {{$carpetMaterials->sum('total_price_af')}} AF</td>
                        </tr>
                        <tr>
                          <th>مجموع پول دالر</th>
                          <td style="direction: ltr"> {{$carpetMaterials->sum('total_price')}} AF</td>
                        </tr>
                        </tbody>
                      </table>
                    </div>
