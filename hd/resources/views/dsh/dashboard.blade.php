                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-xs" id="carpet-list">
                      ...
                      <tr>
                        ...
                        <td colspan="2"><b>مجموع متراژ</b></td>
                        <td  colspan="2" style="direction: ltr"> {{$all_carpets_for_centeral->sum('area')}} m <sup>2</sup></td>
                      </tr>
                      <tr>
                        <td  colspan="2"><b>تعداد</b></td>
                        <td  colspan="2">{{$all_carpets_for_centeral->count()}}</td>
                      </tr>
                       <tr>
                        <td  colspan="2"><b> مجموع قیمت افغانی</b></td>
                        <td  colspan="2">{{$all_carpets_for_centeral->sum('total_price_af')}}</td>
                      </tr>
                       <tr>
                        <td  colspan="2"><b> مجموع قیمت دالر</b></td>
                        <td  colspan="2">{{$all_carpets_for_centeral->sum('total_price')}}</td>
                      </tr>
                      </tbody>
                    </table>
                  </div>
