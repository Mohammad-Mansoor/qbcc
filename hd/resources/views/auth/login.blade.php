...
<!-- Mirrored from ableproadmin.com/bootstrap/default/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Nov 2020 06:44:50 GMT -->
<!-- Added by HTTrack -->
      ...
      <div class="row align-items-center text-center">
        <div class="col-md-12">
          <div class="card-body">
            ...
            <img src="/printStyle/logo.png" width="100px" height="80px" alt="" class="img-fluid mb-4">
            ...
            <form action="/login" method="post" id="loginForm">
              ...
              @if(Session::has('error'))
                <p class="text-danger bold"><strong>Invalid Credential, Please try again!</strong></p>
              @endif
