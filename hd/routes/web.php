...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'usertype:SO,SCO,SP,DE']], function () {
...
/** Sales and Finishing Center Routes */
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'usertype:SO,CCO,SCO,SP,OM,DE']], function () {
...
/** centeral office rout for mazar users  */
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'usertype:CO,SP,SO']], function () {
...
/** end centeral office rout for mazar user*/



/** Central office Routes */
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'usertype:CCO,SP']], function () {
...
/** shared routes */
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'usertype:SO,SP,SCO,CCO,OM,DE']], function () {
...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'usertype:SO,SP']], function () {
...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'usertype:CO,CCO,SCO,SP,MO,SO,PH,OM,DE']], function () {
    Route::get('/', 'DashboardController@Index');
    ...
    Route::post('/all-carpet-dashboard/search', 'DashboardController@search_all_carpet_dashboard');
      Route::post('/search-this-month-carpet','DashboardController@search_this_month_carpet');
});

Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'usertype:CCO,SP,AO']], function () {
