...
class AddErpFieldsToCarpetWashesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('carpet_washes', function (Blueprint $table) {
            ...
            $table->foreign('inventory_transaction_id')->references('id')->on('inventory_transactions')->onDelete('set null');
        });
    }
