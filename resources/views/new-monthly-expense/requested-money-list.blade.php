            ...
            <table class="table table-hover table-xs" id="dataTable">
              ...
              @if($requests)
                ...
                @foreach($requests as $r)
                    ...
                    $account_name = DB::table('new_different_accounts')
                    ...
                    <tr class="ur{{$r->id}}">
                      ...
                      @if($r->type == 'رسید')
                        <td>{{$r->amount}} @if($r->currency == 1) افغانی @elseif($r->currency == 2 ) دالر @else کلدار @endif</td>
                      @else
                        <td>0</td>
                      @endif
                      @if($r->type == 'گرفت')
              ...
              .then((willDelete) => {
                  if (willDelete) {
                      $.ajax({
                          ...
                          url: '/dashboard/new-different-account-approve-request-money/' + id,
              ...
              .then((willDelete) => {
                  if (willDelete) {
                      $.ajax({
                          ...
                          url: '/dashboard/new-different-account-delete-request-money/' + id,
                          success: function (res) {
