            ...
            <tr>
                <td style="border: none; padding: 0;">
                    ...
                    <div class="content-wrapper">
                        <table
                            style="width: 100%; border-bottom: 1px solid #1e3a8a; padding-bottom: 2px; margin-bottom: 5px;">
                            <tr>
                        ...
                        <table class="meta-table">
                            <tr>
                                <td style="width: 33%; text-align: right;">
                                    ...
                                    <span class="meta-val-primary"
                                        style="font-family: monospace; color: #2563eb; direction: ltr;">{{ $batch->reference_number }}</span>
                                </td>
                                <td style="width: 33%; text-align: right;">
                                    <span class="meta-label">وضعیت:</span>
                                    <span class="meta-val-primary"
                                        style="color: {{ $batch->status == 'open' ? '#16a34a' : '#dc2626' }};">
                            ...
                            <tr>
                                <td style="width: 50%; vertical-align: top; padding-left: 5px;">
                                    <div class="billing-section">
                                        ...
                                        <div class="billing-details">
                                            @if($team)
                                                <strong>نام تیم:</strong> {{ $team->name }} | <strong>تلفن:</strong>
                                                {{ $team->phone ?? 'N/A' }}<br>
                                            @else
                                ...
                                <td style="width: 50%; vertical-align: top; padding-right: 5px;">
                                    <div class="billing-section">
                                        ...
                                        <div class="billing-details">
                                            <strong>تعداد قالین:</strong> <span
                                                style="direction: ltr;">{{ $carpets->count() }} Pcs</span> |
                                            <strong>مجموع مساحت:</strong> <span
                                                style="direction: ltr;">{{ number_format($carpets->sum(function ($c) {
    return $c->carpet->area ?? 0; }), 2) }}
                                                m²</span>
                                        </div>
                                    </div>
                                </td>
                        ...
                        <h4 style="font-size: 10pt; color: #0f172a; margin-bottom: 2px; margin-top: 0;">لیست قالین‌ها
                        </h4>
                                    ...
                                    @if($payments && $payments->count() > 0)
                                        <div style="padding-left: 10px;">
                                            ...
                                            <table class="ledger-table" style="margin-top: 0;">
                                                <thead>
                                                    <tr>
                                                        <th style="background-color: #475569 !important; padding: 2px;">
                                                            تاریخ</th>
                                                        <th style="background-color: #475569 !important; padding: 2px;">بابت
                                                        </th>
                                                        <th style="background-color: #475569 !important; padding: 2px;">مبلغ
                                                            اصلی</th>
                                                        <th style="background-color: #475569 !important; padding: 2px;">
                                                            معادل ($)</th>
                                                    </tr>
                                                    ...
                                                    @foreach($payments as $pay)
                                                        <tr>
                                                            ...
                                                            <td class="text-center" style="direction: ltr;">
                                                                {{ number_format($pay->original_amount, 2) }}
                                                                {{ $pay->currency_code }}</td>
                                                            <td class="text-center font-bold"
                                                                style="direction: ltr; color: #166534;">
                                    ...
                                    <table class="totals-table text-right">
                                        <tr>
                                            <td class="text-left font-bold" style="direction: ltr;">
                                                {{ number_format($carpets->sum(function ($c) {
    return $c->carpet->area ?? 0; }), 2) }}
                                                m²</td>
