    ...
    <div class="container-fluid py-4">
        <div class="page-header-modern d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted mb-0 small"><i class="feather icon-shield text-success mr-1"></i> تایید مالی و
                    پرداخت‌های نمایندگان</p>
            </div>
            <button class="btn btn-primary rounded-lg px-4 font-weight-bold shadow-sm hideOnPrint" onclick="window.print()"
                style="height: 45px;">
                                ...
                                <tr class="ur{{$r->id}}">
                                    <td style="font-weight: 800; color: var(--color-text-main);">
                                        <div style="display:flex; align-items:center; gap:10px;">
                                            <div
                                                style="width:36px; height:36px; border-radius:50%; background:#f1f5f9; display:flex; align-items:center; justify-content:center; font-size:1.1rem; color:var(--color-primary);">
                                    ...
                                    <td style="color: var(--color-text-muted); font-family: monospace;">
                                        {{ number_format($rate, 4) }}</td>
                                    ...
                                    <td class="hideOnPrint">
                                        <div style="display:flex; gap:8px;">
                                            @can('approve_agent_money_requests')
                                            <button onclick="approveRequest({{$r->id}})"
                                                class="ux-btn ux-btn-success ux-btn-icon" title="تایید پرداخت">
                                                <i class="feather icon-check"></i>
                                            </button>
                                            @endcan
                                            @can('delete_agent_money_requests')
                                            <button onclick="deleteRequest({{$r->id}})" class="ux-btn ux-btn-danger ux-btn-icon"
                                                title="رد نمودن">
