                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12" style="margin-top: 34px;">
                                ...
                                <select name="team_id" id="customer_select_id" class="form-control">
                                    <option value="all" {{ ($team_id ?? 'all') == 'all' ? 'selected' : '' }}> همه</option>
                    ...
                    @if(isset($ledgerTransactions))
                        ...
                        <div class="row mb-4 no-print">
                            ...
                            <div class="col-md-3">
                                <div class="card border-0 shadow-sm" style="border-radius: 15px; background: #f8f9fa; border-right: 5px solid #ff9800;">
                                    <div class="card-body p-3">
                                        <span class="text-muted small d-block mb-1">کارهای در حال اجرا (WIP)</span>
                                        <h4 class="font-weight-bold mb-0 text-warning">{{ $wipCount }} <small>تخته قالین</small></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="card border-0 shadow-sm" style="border-radius: 15px; background: #f8f9fa; border-right: 5px solid #2196f3;">
                                    <div class="card-body p-3">
                                        <span class="text-muted small d-block mb-1">وضعیت تیم</span>
                            ...
                            <div class="col-md-3">
                                <div class="card border-0 shadow-sm" style="border-radius: 15px; background: #4caf50; color: white;">
                                    <div class="card-body p-3 text-center">
                                        <span class="opacity-80 small d-block mb-1 text-white">نام تیم تیاری</span>
                        ...
                        <div class="row no-print">
                            <div class="col-lg-12">
                                <h6 class="text-muted mb-3 cursor-pointer" data-toggle="collapse" data-target="#legacyFinishingTable">
                                    <i class="feather icon-clock mr-1"></i> مشاهده جزئیات پرداخت‌های قدیمی (Legacy Logs)
                                </h6>
                                <div class="collapse" id="legacyFinishingTable">
                    ...
                    @if(isset($all_accounts))
                        <div class="row mt-4">
                            <div class="col-lg-12">
                                <h4 class="mb-3 font-weight-bold text-center">خلاصه وضعیت تمامی تیم‌های تیاری</h4>
                                <div class="table-responsive shadow-sm" style="border-radius: 10px;">
                                    <table class="table table-xs table-hover bg-white customer_demands">
                                        <thead class="bg-dark text-white">
                                            <tr>
                                                <th class="py-3">#</th>
                                                <th class="py-3">نام تیم</th>
