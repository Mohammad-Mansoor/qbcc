                ...
                <div class="card-body">
                    ...
                    @if(isset($ledgerTransactions))
                            ...
                            <div class="col-md-3">
                                <div class="card border-0 shadow-sm" style="border-radius: 15px; background: #4caf50; color: white;">
                                    <div class="card-body p-3 text-center">
                                        <span class="opacity-80 small d-block mb-1 text-white">نام تیم شست‌وشو</span>
                        ...
                        <div class="row no-print">
                            <div class="col-lg-12">
                                <h6 class="text-muted mb-3 cursor-pointer" data-toggle="collapse" data-target="#legacyWashingTable">
                                    <i class="feather icon-clock mr-1"></i> مشاهده جزئیات پرداخت‌های قدیمی (Legacy Logs)
                                </h6>
                                <div class="collapse" id="legacyWashingTable">
                    ...
                    @if(isset($all_accounts))
                        <div class="row mt-4">
                            <div class="col-lg-12">
                                <h4 class="mb-3 font-weight-bold text-center">خلاصه وضعیت تمامی تیم‌های شست‌وشو</h4>
                                <div class="table-responsive shadow-sm" style="border-radius: 10px;">
