                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12" style="margin-top: 34px;">
                                ...
                                <select name="customer_id" id="customer_select_id" class="form-control">
                                    <option value="all" {{ ($customer_id ?? 'all') == 'all' ? 'selected' : '' }}> همه</option>
                    ...
                    @if(isset($ledgerTransactions))
                            ...
                            <div class="col-md-3">
                                <div class="card border-0 shadow-sm" style="border-radius: 15px; background: #4caf50; color: white;">
                                    <div class="card-body p-3 text-center">
                                        <span class="opacity-80 small d-block mb-1 text-white">نام مشتری</span>
                        ...
                        <div class="row no-print">
                            <div class="col-lg-12">
                                <h6 class="text-muted mb-3 cursor-pointer" data-toggle="collapse" data-target="#legacyCustomerTable">
                                    <i class="feather icon-clock mr-1"></i> مشاهده جزئیات پرداخت‌های قدیمی (Legacy Logs)
                                </h6>
                                <div class="collapse" id="legacyCustomerTable">
                    ...
                    @if(isset($all_accounts))
                        <div class="row mt-4">
                            <div class="col-lg-12">
                                <h4 class="mb-3 font-weight-bold text-center">خلاصه وضعیت تمامی مشتریان</h4>
                                <div class="table-responsive shadow-sm" style="border-radius: 10px;">
                                    <table class="table table-xs table-hover bg-white customer_demands">
                                        <thead class="bg-dark text-white">
                                            <tr>
                                                <th class="py-3">#</th>
                                                <th class="py-3">نام مشتری</th>
