        ...
        <div class="col-sm-12">
            ...
            <div class="glass-card p-4 mb-4 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0 small"><i class="feather icon-file-text mr-1"></i> لیست و مدیریت بل‌های خرید
                        قالین‌های دریافتی</p>
                </div>
                <div>
                    @can('create_purchase_bill')
            ...
            <div class="row mb-4">
                    ...
                    <div class="card stat-card stat-card-blue p-4 h-100">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="text-right w-100">
                                <div class="stat-card-val">{{ $totalInvoicesCount }} <span
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card stat-card stat-card-indigo p-4 h-100">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="text-right w-100">
                                <div class="stat-card-val">{{ $openInvoicesCount }} <span
                                        style="font-size: 1rem; font-weight: normal;">باز</span></div>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card stat-card stat-card-green p-4 h-100">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="text-right w-100">
                                <div class="stat-card-val">{{ $closedInvoicesCount }} <span
                                        style="font-size: 1rem; font-weight: normal;">بسته</span></div>
                    ...
                    <div class="card stat-card stat-card-teal p-4 h-100">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="text-right w-100">
                                ...
                                <div class="stat-card-lbl">{{ $totalCarpetsCount }} عدد قالین
                                    ({{ number_format($totalArea, 2) }} m²)</div>
                            </div>
                            <div class="stat-card-icon">
            ...
            <div class="glass-card p-4 mb-4 text-right" style="direction: rtl;">
                <form action="/dashboard/check-book" method="GET" class="row align-items-end">
                    <div class="col-md-5 form-group mb-0">
                        ...
                        <input type="text" name="search" class="form-control premium-input" placeholder="نمبر بل خرید..."
                            ...
                            @forelse($invoices as $invoice)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/dashboard/check-book/{{ $invoice->id }}"
                ...
                <form action="/dashboard/check-book" method="post" id="createInvoiceForm">
                    ...
                    <div class="modal-body p-4 text-right" style="direction: rtl;">
                        <div class="form-group">
                            ...
                            <input type="text" name="invoice_number" class="form-control premium-input"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="date" class="form-control premium-input" value="{{ date('Y-m-d') }}"
                                required>
                        </div>
                    </div>
