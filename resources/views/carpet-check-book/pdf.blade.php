...
<body onload="window.print()">
    ...
    <table class="meta-table">
        <tr>
            <td style="width:25%;">
                ...
                <span class="meta-val" style="direction: ltr; font-family: monospace; color: #2563eb;">{{ $invoice->invoice_number }}</span>
            </td>
            <td style="width:25%;">
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center" style="direction:ltr;">${{ number_format($carpet->area > 0 ? $carpet->total_price / $carpet->area : 0, 2) }}</td>
                <td class="text-center font-bold" style="direction:ltr; color:#059669;">${{ number_format($carpet->total_price, 2) }}</td>
            </tr>
            @empty
            <tr>
    ...
    <table class="totals-table">
        <tbody>
            <tr>
                <td colspan="7" style="text-align:right; width:71%;">مجموع کلی (Grand Total) — {{ number_format($carpets->count()) }} تخته</td>
        ...
        <tr>
            <td style="width: 55%; vertical-align: top;">
                ...
                <div style="padding-left: 10px;">
                    <h5 style="font-size: 8pt; color: #0f172a; margin: 0 0 4px 0;">تاریخچه تادیات و پرداخت‌ها (Payment History)</h5>
                        ...
                        <tbody>
                            @foreach($invoice->allocations as $pay)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="direction: ltr;">{{ number_format($pay->allocated_amount, 2) }} {{ $ap->currency_code }}</td>
            ...
            <td style="width: 45%; vertical-align: top;">
                <table class="data-table text-right" style="border: none;">
                    <tr>
                        <td class="text-left font-bold" style="direction: ltr; border: none; border-bottom: 1px solid #e2e8f0; background: transparent !important;">{{ $carpets->count() }} تخته</td>
                        <td class="font-bold" style="border: none; border-bottom: 1px solid #e2e8f0; color: #64748b; background: transparent !important;">مجموع تعداد (Quantity):</td>
                    </tr>
                    <tr>
                        <td class="text-left font-bold" style="direction: ltr; border: none; border-bottom: 1px solid #e2e8f0; background: transparent !important;">{{ number_format($sum_area, 2) }} m²</td>
                        <td class="font-bold" style="border: none; border-bottom: 1px solid #e2e8f0; color: #64748b; background: transparent !important;">مجموع مساحت (Total Area):</td>
                    </tr>
                    <tr>
                        <td class="text-left font-bold" style="direction: ltr; border: none; border-top: 1px solid #1e3a8a; border-bottom: 1px solid #1e3a8a; background: #eff6ff !important; color: #2563eb !important; font-size: 9.5pt;">${{ number_format($sum_purchase, 2) }}</td>
                        <td class="font-bold" style="border: none; border-top: 1px solid #1e3a8a; border-bottom: 1px solid #1e3a8a; background: #eff6ff !important; color: #2563eb !important; font-size: 9.5pt;">مبلغ کل قابل تادیه (Grand Total USD):</td>
                    </tr>
                    <tr>
                        <td class="text-left font-bold" style="direction: ltr; border: none; border-bottom: 1px solid #e2e8f0; background: transparent !important; color: #16a34a;">${{ number_format($invoice->paid_amount, 2) }}</td>
                        <td class="font-bold" style="border: none; border-bottom: 1px solid #e2e8f0; color: #64748b; background: transparent !important;">مجموع پرداخت شده (Total Paid USD):</td>
                    </tr>
                    <tr>
                        <td class="text-left font-bold" style="direction: ltr; border: none; border-bottom: 1px solid #e2e8f0; background: transparent !important; color: #dc2626;">${{ number_format($invoice->remaining_balance, 2) }}</td>
                        <td class="font-bold" style="border: none; border-bottom: 1px solid #e2e8f0; color: #64748b; background: transparent !important;">باقیمانده (Remaining Balance USD):</td>
                    </tr>
                    <tr>
                        <td class="text-left font-bold" style="direction: ltr; border: none; border-bottom: 1px solid #e2e8f0; background: transparent !important;">
                        ...
                        <td class="font-bold" style="border: none; border-bottom: 1px solid #e2e8f0; color: #64748b; background: transparent !important;">وضعیت تصفیه مالی (Payment Status):</td>
                    </tr>
                </table>
            </td>
        </tr>
