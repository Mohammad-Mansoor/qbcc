@extends('dsh.master')
@section('title', 'Purchased Carpet Registry - QBIC Forensic ERP')
...
@section('content')
    <style>
        :root {
            ...
            --QBIC-accent: #3b82f6;
            --QBIC-glass: rgba(255, 255, 255, 0.8);
            --QBIC-border: #e2e8f0;
            --radius-lg: 16px;
        ...
        <div class="col-sm-12">
            ...
            <div class="glass-card p-4 mb-4 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0 small"><i class="feather icon-shopping-cart mr-1"></i> مدیریت و ارزش‌گذاری
                        قالین‌های خریداری شده با متدولوژی Forensic FX</p>
                </div>
                <div class="d-flex">
                    @can('create_buy_carpet')
                        <button class="btn btn-primary rounded-lg shadow px-4 py-2" data-toggle="modal"
                            data-target="#buyCarpetModal">
                ...
                <form method="GET" action="/dashboard/list-buy-carpet">
                    <div class="row align-items-end mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="date" name="from_date" class="form-control premium-input bg-light"
                                value="{{ request('from_date') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label-premium">تا تاریخ:</label>
                            <input type="date" name="to_date" class="form-control premium-input bg-light"
                                value="{{ request('to_date') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label-premium">از نمبر پارچه:</label>
                            <input type="text" name="from_id" class="form-control premium-input bg-light"
                                placeholder="مثال: QB1000" value="{{ request('from_id') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label-premium">تا نمبر پارچه:</label>
                            <input type="text" name="to_id" class="form-control premium-input bg-light"
                                placeholder="مثال: QB1100" value="{{ request('to_id') }}">
                        </div>
                    </div>
                    ...
                    <div class="row align-items-end mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="map_number" class="form-control premium-input bg-light"
                                placeholder="جستجوی نقشه..." value="{{ request('map_number') }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-end">
                            <div class="d-flex" style="gap: 10px; width: auto;">
                                <button class="btn btn-outline-secondary rounded-lg" type="button"
                                    onclick="window.print()"><i class="feather icon-printer"></i></button>
                                <button type="submit" class="btn btn-primary rounded-lg shadow px-4"><i
                                        class="feather icon-search"></i> جستجو / فیلتر</button>
                                @php
                                ...
                                @endphp
                                @if($hasFilters)
                                    <a href="/dashboard/list-buy-carpet" class="btn btn-outline-danger rounded-lg px-4"><i
                                            class="feather icon-x"></i> پاکسازی</a>
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="font-weight-bold text-dark">
                                            ...
                                            {{ $carpet->currency_code ?? '$' }}</div>
                                        <small class="text-muted">Native Price</small>
                                    </td>
                                    <td class="text-right">
                                        <div class="text-primary font-weight-bold" data-toggle="tooltip"
                                            title="Exchange Rate: {{ number_format($carpet->exchange_rate, 4) }}">
                                            ${{ number_format($carpet->total_price, 2) }}
                                        </div>
                                        <small
                                            class="text-success font-weight-bold">{{ number_format($carpet->total_price_af, 0) }}
                                            AFN</small>
                                    </td>
                                    <td>
                                        <span
                                            class="status-badge {{ $carpet->status == 12 ? 'badge-repair' : 'badge-purchased' }}">
                                    ...
                                    <td class="text-center hideOnPrint" style="min-width: 150px; position: relative;">
                                        <div class="btn-group align-items-center">
                                            @can('edit_buy_carpet')
                                                <a href="/dashboard/edit-buy-carpet/{{$carpet->carpet_id}}"
                                                    class="btn btn-sm btn-light-primary border-0 shadow-none p-2" title="Edit"><i
                                                        class="feather icon-edit-2"></i></a>
                                            @endcan
                                            <a href="/dashboard/show-buy-carpet/{{$carpet->carpet_id}}"
                                                class="btn btn-sm btn-light-info border-0 shadow-none p-2 mx-1"
                                                title="Details"><i class="feather icon-eye"></i></a>

                                            <div class="dropdown" style="position: static;">
                                                <button class="btn btn-sm btn-light-secondary border-0 shadow-none p-2 no-caret"
                                                ...
                                                <div class="dropdown-menu shadow-lg border-0"
                                                    ...
                                                    <h6 class="dropdown-header small text-muted font-weight-bold">عملیات انتقال
                                                        (Transfer)</h6>
                                                    @if($carpet->status != 12)
                                                        @can('send_carpet_to_kachaee')
                                                        <a class="dropdown-item py-2 px-3 small"
                                                            href="/dashboard/carpet-repaire/sending-to-kachaee/{{$carpet->carpet_id}}">
                                                            <i class="feather icon-tool mr-2 text-warning"></i> ارسال به کچایی
                                                            (Repair)
                                                        </a>
                                                        @endcan
                                                    @endif
                                                    ...
                                                    <a class="dropdown-item py-2 px-3 small"
                                                        ...
                                                        <i class="feather icon-check-circle mr-2 text-success"></i> ارسال به
                                                        تیاری (Finish)
                                                    </a>
                                                    @endcan
                                                    <div class="dropdown-divider"></div>
                                                    <button class="dropdown-item py-2 px-3 small text-primary font-weight-bold"
                                                        onclick="sendToStock({{$carpet->carpet_id}}, {{$carpet->warehouse_id ?? 'null'}})">
            ...
            <div class="modal-content glass-card border-0 overflow-hidden">
                <div class="modal-header border-bottom p-4 bg-light">
                    <h5 class="font-weight-bold mb-0 text-primary">
                        {{ $editCarpet ? 'ویرایش اطلاعات خرید' : 'ثبت خرید قالین جدید' }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form
                    action="{{ $editCarpet ? '/dashboard/upd-buy-carpet/' . $editCarpet->carpet_id : '/dashboard/post-buy-carpet' }}"
                    method="post" enctype="multipart/form-data" id="buyCarpetForm">
                    @csrf
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            ...
                            <div class="col-md-8 border-right">
                                <h6 class="font-weight-bold text-primary mb-4 border-bottom pb-2"><i
                                        class="feather icon-info mr-1"></i> مشخصات عمومی خرید</h6>
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        <label class="form-label-premium">نمبر پارچه (System ID)</label>
                                        <input type="text" value="{{ $editCarpet ? $editCarpet->carpet_no : $AccountNo }}"
                                            class="form-control premium-input bg-light" readonly>
                                        <input type="hidden" name="carpet_no"
                                            value="{{ $editCarpet ? $editCarpet->carpet_no : $AccountNo }}">
                                    </div>
                                    <div class="col-md-3 form-group">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select name="purchase_invoice_id" id="modal_purchase_invoice_id"
                                            class="form-control select2">
                                            <option value="">انتخاب بل خرید...</option>
                                            @foreach($purchaseInvoices as $invoice)
                                                <option value="{{$invoice->id}}" data-agent="{{ $invoice->agent_id }}" {{ ($editCarpet && $editCarpet->purchase_invoice_id == $invoice->id) || (old('purchase_invoice_id') == $invoice->id) ? 'selected' : '' }}>
                                                    {{$invoice->invoice_number}} ({{$invoice->agent->user->name ?? ''}})
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select name="type_id" id="modal_type_id" class="form-control premium-input"
                                            required>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select name="quality_id" id="modal_quality_id" class="form-control premium-input"
                                            required>
                                            <option value="">انتخاب...</option>
                                            @if($editCarpet)
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input type="text" name="map_number" value="{{ $editCarpet->map_number ?? '' }}"
                                            class="form-control premium-input" placeholder="Map No.">
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label class="form-label-premium">تاریخ خرید</label>
                                        <input type="date" name="date" value="{{ $editCarpet->date ?? date('Y-m-d') }}"
                                            class="form-control premium-input" required>
                                    </div>
                                </div>

                                <h6 class="font-weight-bold text-primary mb-4 border-bottom pb-2 mt-4"><i
                                        class="feather icon-maximize mr-1"></i> ابعاد و اندازه‌گیری</h6>
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="margin" value="{{ $editCarpet->margin ?? '' }}"
                                                class="form-control premium-input" placeholder="H">
                                            <input type="text" name="field" value="{{ $editCarpet->field ?? '' }}"
                                                class="form-control premium-input ml-1" placeholder="Z">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <h6 class="font-weight-bold text-primary mb-4 border-bottom pb-2"><i
                                        class="feather icon-shield mr-1"></i> Forensic FX Snapshot</h6>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="exchange_rate" id="modal_exchange_rate"
                                        value="{{ $editCarpet->exchange_rate ?? 1 }}">
                                </div>

                                <div class="form-group">
                                    <label class="form-label-premium">قیمت فی متر (Native Rate)</label>
                                    <input type="number" step="0.01" name="price_input" id="modal_price_input"
                                        value="{{ $editCarpet->original_price ?? $editCarpet->price ?? '' }}"
                                        class="form-control premium-input border-primary font-weight-bold" required>
                                </div>
                                ...
                                <div class="forensic-snapshot">
                                    ...
                                    <div class="small text-center text-muted">
                                        <i class="feather icon-activity mr-1"></i> Conversion: 1 USD = <span
                                            id="modal_rate_display">1.00</span> <span id="modal_code_display">USD</span>
                                    </div>
                                ...
                                <h6 class="font-weight-bold text-dark mb-3 mt-4 border-bottom pb-2 small uppercase"><i
                                        class="feather icon-briefcase mr-1"></i> تنظیمات انبار و دفتر کل</h6>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="imageInput"
                                            style="border-radius: 10px;">انتخاب عکس...</label>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content glass-card border-0 overflow-hidden"
                ...
                <div class="modal-body p-4">
                    <p class="text-muted small mb-4" style="line-height: 1.8; text-align: right; direction: rtl;">
                        با تایید نهایی این محصول، وضعیت آن به <strong>تکمیل شده (In Stock)</strong> تغییر یافته و از وضعیت
                        موقت خارج خواهد شد. لطفاً گدام نهایی را جهت انتقال محصول انتخاب کنید:
                    </p>
