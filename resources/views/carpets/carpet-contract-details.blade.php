@extends('dsh.master')
@section('title', 'Carpet Details - ' . $carpet->parcha_number)
        ...
        <div class="col-md-4">
            <div class="glass-card p-4 mb-4 text-center">
                ...
                <div class="badge badge-pill {{ $carpet->status == 5 ? 'badge-success' : 'badge-primary' }} px-3 py-2">
                    {{ $carpet->status == 5 ? 'تکمیل شده (Completed)' : 'در حال بافت (WIP)' }}
                </div>
            </div>
            ...
            <div class="glass-card p-4 mb-4">
                ...
                <div class="forensic-snapshot">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        @endphp
                        <span
                            class="text-success font-weight-bold">{{ number_format($carpet->total_price * $displayRate, 0) }}
                            AFN</span>
                    </div>
                    <div class="mt-3 pt-3 border-top small text-muted text-center">
                        <i class="feather icon-clock mr-1"></i> Exchange Rate: 1 USD = {{ number_format($displayRate, 2) }}
                        AFN
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card p-4">
                <ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
                    <li class="nav-item mr-2">
                        <a class="nav-link {{ $material == null ? 'active' : '' }}" id="pills-carpet-details-tab"
                            data-toggle="pill" href="#carpet-details">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $material != null ? 'active' : '' }}" id="pills-material-recieves-tab"
                            data-toggle="pill" href="#material-recieves">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <!-- TAB: DETAILS -->
                    <div class="tab-pane fade {{ $material == null ? 'show active' : '' }}" id="carpet-details"
                        role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="bg-light p-3 rounded-lg mb-3">
                                    ...
                                    <span class="font-weight-bold">{{ $carpet->carpet_order->order_number ?? 'N/A' }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="bg-light p-3 rounded-lg mb-3">
                            ...
                            <div class="bg-light p-4 rounded-lg">
                                ...
                                <form action="/dashboard/check-book" method="post">
                                    ...
                                    <div class="row">
                                            ...
                                            <select name="currency_id" id="check_currency_id"
                                                ...
                                                @foreach($currencies as $curr)
                                                    <option value="{{ $curr->id }}" data-rate="{{ $curr->exchange_rate }}"
                                                        data-code="{{ $curr->code }}">{{ $curr->code }} ({{ $curr->symbol }})
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label class="form-label-premium">مقدار کچایی (<span
                                                    id="check_ppm_label">USD</span>)</label>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" name="kachaee_dollar_amount" id="check_kachaee_usd"
                                                class="form-control premium-input bg-white" readonly>
                                        </div>
                                        <div class="col-md-3 form-group">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" name="height" value="{{$carpet->height}}"
                                                class="form-control premium-input" readonly>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label class="form-label-premium">عرض</label>
                                            <input type="text" name="width" value="{{$carpet->width}}"
                                                class="form-control premium-input" readonly>
                                        </div>
                                        <div class="col-md-3 form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary rounded-lg px-5 shadow mt-3">ذخیره چک
                                        بٌک</button>
                                </form>
                            </div>
                        @else
                            <div id="editDetails">
                                <div class="d-flex justify-content-between mb-4">
                                    ...
                                    <button class="btn btn-info btn-sm rounded-pill" id="editBtn"><i
                                            class="feather icon-edit mr-1"></i> ویرایش</button>
                                </div>
                                <table class="table table-bordered">
                                    <tr>
                                        <th class="bg-light w-25">شماره چک بوک</th>
                                        <td>{{$carpetCheckBook->check_number}}</td>
                                    </tr>
                                    <tr>
                                        <th class="bg-light">طول / عرض</th>
                                        <td>{{$carpetCheckBook->height}} x {{$carpetCheckBook->width}}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-weight-bold">
                                            {{number_format($carpetCheckBook->kachaee_amount, 2)}}
                                            {{ $carpetCheckBook->currency_code ?? 'AFN' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-primary font-weight-bold">
                                            ...
                                            @if($carpetCheckBook->currency_code && $carpetCheckBook->currency_code != 'USD')
                                                <span class="small text-muted ml-2">(Rate:
                                                    {{ number_format($carpetCheckBook->exchange_rate, 4) }})</span>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <form action="/dashboard/check-book/{{$carpetCheckBook->id}}" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select name="currency_id" id="check_currency_id_edit"
                                                class="form-control border-info">
                                                @foreach($currencies as $curr)
                                                    <option value="{{ $curr->id }}" data-rate="{{ $curr->exchange_rate }}"
                                                        data-code="{{ $curr->code }}" {{ ($carpetCheckBook->currency_code == $curr->code) ? 'selected' : '' }}>
                                                        {{ $curr->code }} ({{ $curr->symbol }})</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" name="exchange_rate" id="check_exchange_rate_edit"
                                                value="{{ $carpetCheckBook->exchange_rate }}">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label class="form-label-premium">مقدار کچایی (<span
                                                    id="check_ppm_label_edit">{{ $carpetCheckBook->currency_code ?? 'AFN' }}</span>)</label>
                                            <input type="number" step="0.01" name="kachaee_amount_input"
                                                id="check_kachaee_input_edit" value="{{$carpetCheckBook->kachaee_amount}}"
                                                class="form-control premium-input border-info">
                                            <input type="hidden" name="kachaee_amount" id="final_kachaee_native_edit"
                                                value="{{$carpetCheckBook->kachaee_amount}}">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label class="form-label-premium">معادل دالر</label>
                                            <input type="text" name="kachaee_dollar_amount" id="check_kachaee_usd_edit"
                                                value="{{$carpetCheckBook->kachaee_dollar_amount}}"
                                                class="form-control premium-input bg-white" readonly>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label class="form-label-premium">نمبر چک بوک</label>
                                            <input type="text" name="check_number" value="{{$carpetCheckBook->check_number}}"
                                                class="form-control premium-input">
                                        </div>
                                    ...
                                    <button type="submit" class="btn btn-info rounded-lg px-5 shadow mt-3">بروزرسانی چک
                                        بٌک</button>
                                    <button type="button" class="btn btn-light rounded-lg px-4 mt-3 ml-2"
                                        onclick="$('#editForm').hide(); $('#editDetails').show();">انصراف</button>
                                </form>
                            </div>
                        @endif
                    </div>
                    ...
                    <!-- TAB: MATERIAL -->
                    <div class="tab-pane fade {{ $material != null ? 'show active' : '' }}" id="material-recieves"
                        role="tabpanel">
                        <div class="bg-light p-4 rounded-lg mb-4">
                            <h5 class="font-weight-bold mb-4">
                                {{ $material ? 'ویرایش دریافت مواد' : 'ثبت دریافت مواد جدید' }}</h5>
                            <form
                                action="{{ $material ? '/dashboard/carpet-material/' . $material->id : '/dashboard/carpet-material' }}"
                                method="post">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select name="currency_id" id="mat_currency_id" class="form-control border-primary">
                                            @foreach($currencies as $curr)
                                                <option value="{{ $curr->id }}" data-rate="{{ $curr->exchange_rate }}"
                                                    data-code="{{ $curr->code }}" {{ ($material && $material->currency_code == $curr->code) || (!$material && $curr->code == 'AFN') ? 'selected' : '' }}>{{ $curr->code }} ({{ $curr->symbol }})</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input type="number" step="0.01" name="amount" id="material-amount"
                                            value="{{ $material->amount ?? '' }}"
                                            class="form-control premium-input border-primary" required>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label class="form-label-premium">قیمت فی کیلو (<span
                                                id="mat_unit_label">AFN</span>)</label>
                                        <input type="number" step="0.01" name="price" id="material-price"
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select name="type_id" class="form-control">
                                            @foreach ($material_types as $type)
                                                <option value="{{$type->material_type_id}}" {{ ($material && $material->type_id == $type->material_type_id) ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-3 form-group">
                                        <label class="form-label-premium">تاریخ</label>
                                        <input type="date" name="date" value="{{ $material->date ?? $carpet->date }}"
                                            class="form-control premium-input">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select name="credit_account_id" class="form-control select2">
                                            @foreach($rawMaterialAccounts as $acc)
                                                <option value="{{$acc->id}}" {{ $acc->account_code == '1202' ? 'selected' : '' }}>
                                                    {{$acc->account_name}} ({{$acc->account_code}})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row forensic-snapshot m-1 mb-3">
                                    <div class="col-6"><small class="text-muted">مجموع به اسعار:</small> <span
                                            id="mat_native_total_label" class="font-weight-bold">0.00 AFN</span></div>
                                    <div class="col-6 text-right"><small class="text-muted">معادل دالر (Normalized):</small>
                                        <span id="mat_usd_total_label" class="font-weight-bold text-primary">$0.00</span>
                                    </div>
                                ...
                                <div class="text-right">
                                    <button type="submit"
                                        class="btn btn-primary px-5 rounded-lg shadow">{{ $material ? 'بروزرسانی' : 'ذخیره مواد' }}</button>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-primary font-weight-bold">
                                                ...
                                                @if($mat->currency_code && $mat->currency_code != 'USD')
                                                    <div class="small text-muted" style="font-size: 10px;">Forensic FX:
                                                        {{ number_format($mat->exchange_rate, 4) }}</div>
                                                @endif
                                            </td>
                                            <td>{{ $mat->type->material_type ?? 'N/A' }}
                                                ({{ $mat->category->material_category ?? 'N/A' }})</td>
                                            <td>{{ $mat->date }}</td>
                                            <td class="hideOnPrint">
                                                <a href="/dashboard/carpet-material/{{$mat->id}}/edit"
                                                    class="btn btn-sm btn-light-info"><i class="feather icon-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    <script>
        $(document).ready(function () {
            ...
            function runMaterialCalc() {
                ...
                // But usually, we just save the AFN total if that's what's needed.
                // Let's check the dollar_rate from the carpet record
                let carpet_dollar_rate = {{ $carpet->dollar_rate > 0 ? $carpet->dollar_rate : 63 }};
                $('#material-af-total-price').val((usd_total * carpet_dollar_rate).toFixed(2));
            }
