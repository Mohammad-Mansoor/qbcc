    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card stat-card stat-card-blue p-4 h-100">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="stat-card-val">{{ $totalPendingCount }} <span style="font-size: 1rem; font-weight: normal;">درخواست</span></div>
                ...
                <div class="static-table-list table-responsive" id="MRDetails">
                    <table class="table table-modern text-center mb-0" id="dataTable">
                        ...
                        <tbody>
                            @if(count($requests) > 0)
                                @foreach($requests as $r)
                                    ...
                                    <tr class="ur{{$r->id}}">
                                        ...
                                        <td>
                                            @if($r->type == 'رسید')
                                                <span class="badge badge-success badge-premium" style="background: rgba(16, 185, 129, 0.1); color: #10b981;">رسید</span>
                                            @else
                                                <span class="badge badge-danger badge-premium" style="background: rgba(239, 68, 68, 0.1); color: #ef4444;">گرفت</span>
                                            @endif
                                        </td>
                            ...
                            @else
                                <tr>
                                    <td colspan="9" class="text-center py-4 font-weight-bold text-danger">هنوز درخواست پول ثبت نشده است.</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
...
<div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog" aria-labelledby="confirmationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="border-radius: 16px; border: none; background: rgba(255, 255, 255, 0.98); box-shadow: 0 20px 50px rgba(0,0,0,0.15); overflow: hidden;">
            <div class="modal-header text-white p-4" id="modalHeader" style="border: none;">
                <h5 class="modal-title font-weight-bold" id="confirmationModalLabel" style="font-size: 1.2rem;">تایید عملیات</h5>
                <button type="button" class="close text-white font-weight-bold" data-dismiss="modal" aria-label="Close" style="opacity: 0.8; outline: none; margin: -20px -20px -20px auto; background: none; border: none;">
                    ...
                    <table class="table table-sm table-borderless mb-0 text-right" style="font-size: 0.9rem;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="detailRate" class="font-weight-bold text-secondary" style="direction: ltr;"></td>
                            </tr>
                            <tr>
            ...
            <div class="modal-footer bg-light p-3" style="border: none;">
                <div class="w-100 d-flex justify-content-between align-items-center">
                    <button type="button" class="btn btn-light shadow-sm px-4" data-dismiss="modal" style="border-radius: 8px; font-weight: 600;">انصراف</button>
                    <button type="button" id="btnConfirmAction" class="btn text-white shadow-sm px-4" style="border-radius: 8px; font-weight: 600; border: none;"></button>
                </div>
            </div>
        </div>
    </div>
