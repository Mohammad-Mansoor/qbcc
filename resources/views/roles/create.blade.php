                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group fill">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="نام نقش را وارد کنید (مثلا: مدیر فروشات)" required>
                                </div>
                            </div>
                                                    ...
                                                    <div class="card-body p-3" style="max-height: 250px; overflow-y: auto;">
                                                        @foreach($group['perms'] as $permission)
                                                            <div class="custom-control custom-checkbox mb-2">
                                                                <input type="checkbox" name="permission[]" value="{{ $permission->id }}" class="custom-control-input perm-checkbox group_{{ $key }}_checkbox" id="perm_{{ $permission->id }}">
...
<script>
    $(document).ready(function() {
        ...
        $('.group-checkbox').change(function() {
            ...
            $('.' + groupId + '_checkbox').prop('checked', $(this).prop('checked'));
        });
