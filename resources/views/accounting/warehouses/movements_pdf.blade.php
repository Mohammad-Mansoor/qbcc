...
<head>
    ...
    <style>
        ...
        .meta-val-primary { font-size: 9pt; font-weight: bold; color: #0f172a; margin: 0; }
...
<body onload="window.print();">
    ...
    <table style="width: 100%; border-bottom: 1px solid #1e3a8a; padding-bottom: 5px; margin-bottom: 5px;">
        <tr>
            <td style="width: 10%; text-align: right;">
                @if(isset($logoBase64) && $logoBase64)
                    <img src="data:image/png;base64,{{ $logoBase64 }}" class="logo" alt="Logo">
                @else
                    <div style="width: 40px; height: 40px; background: #eee; text-align: center; line-height: 40px; font-weight: bold;">LOGO</div>
                @endif
            </td>
