...
<head>
    ...
    <?php $x = 'x:'; echo "<xml>
        <{$x}ExcelWorkbook>
            <{$x}ExcelWorksheets>
                <{$x}ExcelWorksheet>
                    <{$x}Name>Customer Statement</{$x}Name>
                    <{$x}WorksheetOptions>
                        <{$x}DisplayGridlines/>
                        <{$x}FreezePanes/>
...
<body>
    <table>
        ...
        <!-- Report Title Header -->
        <tr>
            <td colspan="6" class="report-title" valign="middle">صورت حساب تفصیلی مشتری (Detailed Customer Statement)</td>
        </tr>
        ...
        <tr>
            <td class="meta-label" style="height: 24pt;">صورت حساب مشتری:</td>
            <td class="meta-value font-bold" style="height: 24pt;">{{ $customer->name }}</td>
            <td class="meta-label" style="height: 24pt;">کد مشتری:</td>
            <td class="meta-value" style="height: 24pt;">{{ $customer->customer_code }}</td>
