                ...
                <div class="content-wrapper">
                    <div class="title-block">
                        @if(request()->get('type') === 'summary')
                            <h2 class="title-main">صورت حساب خلاصه {{ trim(explode('(', $config['title'])[0]) }}</h2>
                            <p class="title-sub">Summary {{ isset(explode('(', $config['title'])[1]) ? trim(str_replace(')', '', explode('(', $config['title'])[1])) . ' ' : '' }}Statement</p>
                        @else
