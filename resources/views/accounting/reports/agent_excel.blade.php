...
<body>
    <table>
        ...
        <!-- Report Title Header -->
        <tr>
            <td colspan="6" class="report-title" valign="middle">
                @if(request()->get('type') === 'summary')
                    صورت حساب خلاصه نماینده (Summary Agent Statement)
                @else
                    صورت حساب تفصیلی نماینده (Detailed Agent Statement)
                @endif
            </td>
        </tr>
        ...
        <tr>
            <td class="meta-label" style="height: 24pt;">صورت حساب نماینده:</td>
            <td class="meta-value font-bold" style="height: 24pt;">{{ $agent->display_name }}</td>
            <td class="meta-label" style="height: 24pt;">کد نماینده:</td>
            <td class="meta-value" style="height: 24pt;">{{ $agent->account_no }}</td>
        ...
        <tr>
            ...
            <td class="meta-value" style="height: 24pt;">
                @if(request()->get('type') === 'summary')
                    صورت حساب مالی خلاصه (USD)
                @else
                    صورت حساب مالی تفصیلی (USD)
                @endif
            </td>
        </tr>
        <tr>
        ...
        <tbody>
            ...
            <tr class="opening-balance-row">
                ...
                <td class="text-center" style="height: 26pt;">-</td>
                <td class="text-right font-bold" style="height: 26pt; padding-right: 12px;">موجودی ابتدایی دوره (Opening Balance Forwarded)</td>
