        ...
        <form action="/dashboard/carpet-wash" method="post">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mb-3">
              <div class="form-group">
                ...
                <input type="text" name="team_id" required readonly class="form-control" value="{{$carpet_wash->washing_team->name}}">
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 mb-3">
              <div class="form-group">
                ...
                <input type="text" name="wash_number" required readonly class="form-control" value="{{$carpet_wash->wash_number}}">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mb-3">
              <div class="form-group">
                ...
                <input type="text" id="warea" name="area" required readonly class="form-control" placeholder="مساحت محاسبه شده">
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 mb-3">
              <div class="form-group">
                ...
                <input type="text" name="price" placeholder="مصرف شست فی متر" required class="form-control" id="wprice" value="{{old('price')}}">
              ...
              <div class="form-group">
                ...
                <select name="account_id" id="account_id" class="form-control select2" required>
                  @foreach($allowedDebitAccounts as $acc)
                    <option value="{{$acc->id}}" {{ $acc->id == $defaultAccount ? 'selected' : '' }}>{{$acc->account_code}} - {{$acc->account_name}}</option>
                  @endforeach
                </select>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mb-3">
              <div class="form-group">
                ...
                <input type="text" id="af_total_price" name="af_total_price" required readonly class="form-control font-weight-bold text-success">
            ...
            <div class="col-md-3 col-sm-6 mb-3">
              <div class="form-group">
                ...
                <input type="text" id="total_price" name="total_price" required readonly class="form-control font-weight-bold text-primary">
          ...
          <div class="row">
            <div class="col-12 mb-4">
              <div class="form-group">
                ...
                <textarea name="description" id="description" rows="2" required class="form-control" placeholder="توضیحات شست قالین..."></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <a href="/dashboard/carpet-wash/wash-numbers/{{$carpet_wash->team_id}}" class="btn btn-cancel ml-2">انصراف (Cancel)</a>
            </div>
          </div>
