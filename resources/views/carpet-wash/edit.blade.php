                  ...
                  <div class="form-group">
                    ...
                    <select name="team_id" class="form-control" required>
                      @foreach ($washing_team as $team)
                        <option {{($team->id == $wash->team_id ? 'selected' : '')}} value="{{$team->id}}">{{$team->name}}
                        </option>
                      @endforeach
                    </select>
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="hidden" id="original_area" value="{{$wash->carpet->area ?? 0}}">
                    <input type="text" id="warea" name="area" value="{{$wash->area}}" readonly class="form-control mb-1">
                ...
                <div class="col-md-3 col-sm-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="exchange_rate" id="exchange_rate"
                      value="{{ $wash->exchange_rate ?? $currency }}" class="form-control" required>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="warehouse_id" id="warehouse_id" class="form-control select2" required>
                      @foreach($warehouses as $wh)
                        <option value="{{$wh->id}}" {{ (old('warehouse_id', $wash->carpet->warehouse_id) == $wh->id) ? 'selected' : '' }}>
                          {{$wh->name}}
                        </option>
                      @endforeach
                    </select>
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" id="af_total_price" name="af_total_price" value="{{$wash->af_total_price}}"
                ...
                <div class="col-md-3 col-sm-6 mb-3">
                  <div class="form-group">
                    ...
                    <input type="text" id="total_price" name="total_price" value="{{$wash->total_price}}" readonly
                ...
                <div class="col-12 mb-4">
                  <div class="form-group">
                    ...
                    <textarea name="description" id="description" rows="2" class="form-control"
                      placeholder="توضیحات شست قالین...">{{$wash->description}}</textarea>
                  </div>
                </div>
              </div>
