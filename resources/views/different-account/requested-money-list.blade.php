@extends('dsh.master')
@section('title', 'Miscellaneous Money Requests - QBIC Forensic ERP')
        ...
        <div class="col-sm-12">
            ...
            <div class="page-header-modern d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0 small"><i class="feather icon-shield text-success mr-1"></i> صف تایید
                        تراکنش‌های مالی متفرقه (Forensic Ready)</p>
                </div>
                                ...
                                @if(count($requests) > 0)
                                    @foreach($requests as $r)
                                        <tr class="ur{{$r->id}}">
                                            ...
                                            <td>
                                                <span
                                                    class="type-badge {{ $r->type == 'رسید' ? 'badge-receipt' : 'badge-payment' }}">
                                                    {{ $r->type }}
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="small text-muted" dir="ltr">1 {{ $r->currency_code }} =
                                                    {{ number_format($r->exchange_rate, 4) }} USD</div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center hideOnPrint">
                                                <div class="btn-group">
                                                    ...
                                                    <button onclick="approveRequest({{$r->id}})"
                                                        class="btn btn-sm btn-light-success text-success rounded-lg mr-1"
                                                        title="تایید">
                                                    ...
                                                    <button onclick="deleteRequest({{$r->id}})"
                                                        class="btn btn-sm btn-light-danger text-danger rounded-lg" title="رد کردن">
