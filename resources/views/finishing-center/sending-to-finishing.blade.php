...
@section('content')
    ...
    <style>
        /* QBIC PREMIUM GLASSMORPHISM FINISHING (TAYAARI) THEME */
        :root {
            --QBIC-primary: #4f46e5;
            --QBIC-secondary: #6366f1;
            --QBIC-accent: #8b5cf6;
            --QBIC-success: #10b981;
            --QBIC-glass-bg: rgba(255, 255, 255, 0.75);
            --QBIC-glass-border: rgba(238, 242, 255, 0.8);
            --radius-xl: 24px;
            --radius-lg: 16px;
            --radius-md: 12px;
    ...
    <div class="container-fluid premium-container" style="direction: rtl;">
        ...
        <div class="carpet-hero d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
            <div class="d-flex align-items-center gap-4">
                <div class="rounded-circle bg-white text-indigo d-flex align-items-center justify-content-center"
                    style="width: 80px; height: 80px; font-size: 2.2rem; font-weight: 900; box-shadow: var(--shadow-premium);">
                    <i class="feather icon-check-circle" style="color: var(--QBIC-primary);"></i>
                </div>
                <div>
                    <h1 class="h2 font-weight-bold text-white mb-2" style="font-family: inherit;">ثبت قالین برای بخش تیاری
                    </h1>
            ...
            <div class="col-lg-7 mb-4">
                <div class="card glass-card h-100">
                    <div class="card-header border-0 bg-transparent pt-4 px-4 pb-0">
                        ...
                        <p class="text-muted small mt-2">لطفاً تیم تیاری و انبار نهایی (گدام) را برای این تخته قالین تعیین
                            نمایید.</p>
                    </div>
                        ...
                        <form action="/dashboard/carpet-wash/sent-to-finish/{{$carpet->carpet_id}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group mb-4">
                                    ...
                                    <select name="finishing_id" class="form-control form-control-modern select2 w-100"
                                        required>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6 mb-3">
                                <div class="spec-item">
                                    ...
                                    <div class="spec-value" dir="ltr">{{ $carpet->width }} <small
                            ...
                            <div class="col-6 mb-3">
                                <div class="spec-item">
                                    ...
                                    <div class="spec-value" dir="ltr">{{ $carpet->height }} <small
                                            class="text-muted">متر</small></div>
                                </div>
                            </div>
