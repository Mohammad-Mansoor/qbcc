                ...
                @if(!$shiraza_check)
                    <div class="row">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                            <div class="form-group fill">
                                <label class="pull-right">تیاری نمبر</label>
                                <input type="text" name="finish_number_shiraza" id="finish_number_shiraza" value="" readonly
                                       class="form-control class_finish_number_input">

                                @if(session("finish_number_shiraza"))
                                    <small class="text-danger">{{session("finish_number_shiraza")}}
                                    </small>
                                @endif
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="form-group fill">
                                <label class="pull-right">تیم تیاری</label>
                                <select name="team_id_shiraza" class="form-control">
                                    @foreach($teams as $team)
                                        <option value="{{$team->id}}" {{ (old('team_id_shiraza', isset($selected_team_id) ? $selected_team_id : '') == $team->id)?'selected':''}}>{{$team->name}}</option>
                                    @endforeach
                                </select>
                                <small class="text-danger">@error('team_id') {{ __('message.'.$message) }} @enderror</small>
                            </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="form-group fill">
                                <label class="pull-right">نوع تیاری</label>
                                <select name="category_id_shiraza" id="category_id" class="form-control">
                                    {{--@foreach($team_categories as $category)--}}
                                    <option {{ (Request::old('category_id'))}} value="8">شیرازه</option>
                                    {{--@endforeach--}}
                                </select>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="form-group fill">
                                <label class="pull-right">مصرف فی متر یا متر مربع</label>
                                <input type="text" placeholder="مصرف تیاری به دالر"
                                       class="form-control price_af_shiraza" name="price_af_shiraza" id="fpra"
                                       value="{{old('price_af')?old('price_af'): ''}}">
                                <input type="hidden" id="mainPra" value="{{old('price')}}" name="price_shiraza">
                                <input type="hidden" id="currencyra" value="{{$currency}}">
                                <input type="hidden" value="{{$carpet->carpet_id}}"
                                       name="carpetId">
                                @if(session("price_af_shiraza"))
                                    <small class="text-danger">{{session("price_af_shiraza")}}
                                    </small>
                                @endif
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="form-group fill">
                                <label class="pull-right">تاریخ تیاری قالین</label>
                                <input type="date" id="date_shiraza"  name="date_shiraza"
                                       placeholder="تاریخ را وارد کنید" class="form-control"
                                       value="{{old('date')}}">
                                @if(session("date_shiraza"))
                                    <small class="text-danger">{{session("date_shiraza")}}
                                    </small>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                            <div class="form-group fill" style="margin-top: 35px;">
                                ...
                                <div class="switch switch-primary d-inline m-r-10">
                                    <input type="checkbox" id="switch-p-8" class="shiraza_checkbox" name="shiraza_checkbox">
                                    <label for="switch-p-8" class="cr"></label>
                                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                  <div class="form-group fill" style="margin-top: 50px;">
                    ...
                    <input type="radio" class="finished" name="finished" value="1"
                           {{$team_categories->count() == 1?'checked':''}} style="margin-right: 20px;padding:5px;"><span
...
@section('scripts')
  ...
  <script>
      ...
      function valid() {
          ...
          var shiraza_checkbox = $('.shiraza_checkbox').prop('checked');
          if (shiraza_checkbox){

              $('.price_af_shiraza').attr('required','required');
              $('#date_shiraza').attr('required','required');
              $('#finish_number_shiraza').attr('required','required');

          }else{

              $('.price_af_shiraza').removeAttr('required');
              $('#date_shiraza').removeAttr('required');
