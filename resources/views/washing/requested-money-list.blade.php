                        ...
                        <tbody>
                            @if(count($requests) > 0)
                                @foreach($requests as $r)
                                    ...
                                    @endphp
                                    <tr class="ur{{$r->id}}">
                                        <td class="font-weight-bold text-dark">{{ $washing_team ? $washing_team->name : 'N/A' }}</td>
                                        ...
                                        <td>
                                            <span class="badge badge-light-secondary badge-premium font-weight-bold">{{ $r->wash_number ?: 'N/A' }}</span>
                                        </td>
                                        <td>{{ $r->description }}</td>
                                        <td>{{ $r->date }}</td>
