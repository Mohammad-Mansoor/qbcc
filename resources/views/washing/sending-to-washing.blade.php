...
@section('content')
    ...
    <style>
        /* QBIC PREMIUM GLASSMORPHISM WASHING THEME */
        :root {
            --QBIC-primary: #0f766e;
            --QBIC-secondary: #0d9488;
            --QBIC-accent: #06b6d4;
            --QBIC-success: #10b981;
            --QBIC-glass-bg: rgba(255, 255, 255, 0.75);
            --QBIC-glass-border: rgba(204, 251, 241, 0.8);
            --radius-xl: 24px;
            --radius-lg: 16px;
            --radius-md: 12px;
    ...
    <div class="container-fluid premium-container" style="direction: rtl;">
        ...
        <div class="carpet-hero d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
            <div class="d-flex align-items-center gap-4">
                <div class="rounded-circle bg-white text-teal d-flex align-items-center justify-content-center"
                    style="width: 80px; height: 80px; font-size: 2.2rem; font-weight: 900; box-shadow: var(--shadow-premium);">
                    <i class="feather icon-droplet" style="color: var(--QBIC-primary);"></i>
                </div>
                <div>
            ...
            <div class="col-lg-7 mb-4">
                <div class="card glass-card h-100">
                    <div class="card-header border-0 bg-transparent pt-4 px-4 pb-0">
                        ...
                        <p class="text-muted small mt-2">لطفاً تیم شستشو، شماره مرجع شست و انبار موقت را برای این تخته قالین
                            تعیین نمایید.</p>
                    </div>
