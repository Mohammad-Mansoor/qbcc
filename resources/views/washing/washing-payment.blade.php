    ...
    <div class="row profile-card-parent">
        <div class="col-12">
            <ul class="nav nav-tabs nav-tabs-premium border-0" id="washingTabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link font-weight-bold" id="washes-tab" data-toggle="tab" href="#washes" role="tab"><i class="fa fa-tint mr-1"></i> مصارف و کارهای شست‌وشو (Washes & Costs)</a>
                </li>
                <li class="nav-item">
                            ...
                            <div class="table-responsive">
                                <table class="table premium-table table-hover text-right">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $w->date }}</td>
                                            <td><span class="badge badge-light border">{{ $w->wash_number_sh }}</span></td>
                                            <td>{{ $w->carpet->carpet_no ?? 'N/A' }}</td>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="9" class="text-center text-muted py-4">هیچ کار شست‌وشو برای این تیم ثبت نشده است.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
...
<script>
    ...
    @foreach($washes as $w)
        unpaidBalances["{{ $w->wash_number_sh }}"] = parseFloat("{{ $w->remaining_balance }}");
    @endforeach
