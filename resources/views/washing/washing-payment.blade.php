...
<style>
    ...
    .badge-soft-blue { background: var(--soft-blue); color: var(--secondary-blue); }
</style>
...
<div class="container-fluid mt-4" id="washing-payment-dashboard">
            ...
            <form action="{{ $paymentEdit ? '/dashboard/washing-payments/'.$paymentEdit->id : '/dashboard/washing-payments' }}" method="post" id="forensicWashingForm">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 form-group mb-4">
                        ...
                        <select name="wash_number" class="form-control custom-input select2">
                    ...
                    <div class="col-lg-3 col-md-12 text-left">
                        <button class="btn btn-primary btn-block rounded-pill py-3 font-weight-bold shadow-lg" type="submit" style="background:var(--primary-blue); border:none;">
    ...
    <!-- Ledger Table -->
    <div class="premium-card">
        <div class="card-header-premium d-flex justify-content-between align-items-center" style="background: var(--dark-blue);">
            <h5><i class="fa fa-list-alt mr-2"></i> لجر محاسباتی شست‌گر (Forensic Audit Ledger)</h5>
            <div id="exportButton">
                @if(!isset($all))
                    <a href="/dashboard/washing-payments-all/{{$team->id}}" class="btn btn-sm btn-light rounded-pill px-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="hideOnPrint text-center">
                                <div class="btn-group">
                                    <a href="/dashboard/washing-payments/{{$p->id}}/edit" class="btn btn-sm btn-outline-primary border-0">
