                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 hideOnPrint">
                    <div class="btn-group hideOnPrint" id="exportButton" style="float: left; ">
                      <div class="btn btn-sm btn-primary" style="float: left" onclick="printPage('washing-payment')"><i
                                class="fa fa-print"></i> چاپ
                      </div>
                    
                    </div>
                    <a href="/dashboard/washing-payments-all/{{$team->id}}" style="float: left"
                    ...
                    @foreach($payments as $pa)
                      <tr class="ur{{$pa->id}}">
                        ...
                        @else
                          <td>0</td>
                        @endif
                        @if($pa->wash_number == 'نقد')
                          <td>نقد</td>
                        @else
                          
                          
                          <td>
                            <a href="/dashboard/search-wash-numbersh-payment/{{$pa->wash_number}},{{$pa->team_id}}"
                            >&nbsp; {{$pa->wash_number}}</a></td>
                        ...
                        @if( $pa->status == 0 || auth()->user()->role == 'SP')
                          <td class="hideOnPrint text-center">
                            <a href="/dashboard/washing-payments/{{$pa->id}}/edit"
  ...
  <script>
    $('#wash_number').select2();
      ...
      $(document).ready(function () {
          ...
          var $buttons = $('#washing_payment').find('caption').children().detach();
                      ...
                      $.ajax({
                          ...
                          success: function (res) {
                              ...
                              if (res.status == 'success') {
                                  $('.ur' + id).hide();
                                  $('.alert-success').show();
                                  window.location = '/dashboard/washing-payments/' + team_id
                              } else {
                                  $('.alert-danger').show();
                              }
