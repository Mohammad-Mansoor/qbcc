@extends('dsh.master')
@section('title', 'ثبت قالین برای کچایی (ترمیم)')
@section('content')

    <style>
        /* QBIC PREMIUM GLASSMORPHISM THEME */
        :root {
            --QBIC-primary: #1e3a8a;
            --QBIC-secondary: #0ea5e9;
            --QBIC-accent: #f59e0b;
            --QBIC-success: #10b981;
            --QBIC-danger: #ef4444;
            --QBIC-glass-bg: rgba(255, 255, 255, 0.7);
            --QBIC-glass-border: rgba(226, 232, 240, 0.8);
            --radius-xl: 24px;
            --radius-lg: 16px;
            --radius-md: 12px;
            --shadow-premium: 0 20px 40px -15px rgba(0, 0, 0, 0.05), 0 1px 3px rgba(0, 0, 0, 0.02);
        ...
        .glass-card {
            background: var(--QBIC-glass-bg);
            backdrop-filter: blur(16px);
            -webkit-backdrop-filter: blur(16px);
            border: 1px solid var(--QBIC-glass-border);
        ...
        <div class="carpet-hero d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
            <div class="d-flex align-items-center gap-4">
                <div class="rounded-circle bg-white text-primary d-flex align-items-center justify-content-center"
                    style="width: 80px; height: 80px; font-size: 2.2rem; font-weight: 900; box-shadow: var(--shadow-premium);">
                    <i class="feather icon-scissors" style="color: var(--QBIC-primary);"></i>
                </div>
                <div>
                    <h1 class="h2 font-weight-bold text-white mb-2" style="font-family: inherit;">ثبت قالین برای کچایی
                        (ترمیم)</h1>
        ...
        <div class="row">
                ...
                <div class="card glass-card h-100">
                    <div class="card-header border-0 bg-transparent pt-4 px-4 pb-0">
                        <h3 class="card-title font-weight-bold text-dark m-0" style="font-size: 1.25rem;">
                            <i class="feather icon-edit text-primary mr-2"></i> انتخاب تیم و تعیین انبار مقصد
                        </h3>
                        <p class="text-muted small mt-2">لطفاً تیم کچایی (تعمیر کننده) و انبار مقصد برای این قالین را مشخص
                            نمایید.</p>
                    </div>
                        ...
                        <form action="/dashboard/carpet-repair/sent-to-repair/{{$carpetId->carpet_id}}" method="POST">
                            ...
                            <div class="form-group mb-4">
                                <label class="form-label-modern">
                                    <i class="feather icon-users text-primary"></i> تیم کچایی (تعمیر کننده)
                                </label>
                                <select name="team_id" class="form-control form-control-modern select2 w-100" required>
                                    <option value="" disabled selected>انتخاب تیم کچایی...</option>
                                ...
                                @error('team_id')
                                    <p class="text-danger small mt-1"><i class="feather icon-info"></i>
                            ...
                            <div class="form-group mb-4">
                                <label class="form-label-modern">
                                    <i class="feather icon-home text-primary"></i> گدام مقصد (Destination Warehouse)
                                </label>
                            ...
                            <div class="d-flex justify-content-start align-items-center gap-3 pt-3 border-top">
                                <button class="btn btn-modern btn-submit-premium shadow" type="submit">
                                    <i class="feather icon-save"></i> انتقال و ذخیره سند
                                </button>
            ...
            <div class="col-lg-5 mb-4">
                <div class="card glass-card">
                    <div class="card-header border-0 bg-transparent pt-4 px-4 pb-0">
                        <h3 class="card-title font-weight-bold text-dark m-0" style="font-size: 1.25rem;">
                            <i class="feather icon-layers text-primary mr-2"></i> مشخصات تخته قالین
                        </h3>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-6 mb-3">
                                <div class="spec-item">
                                    ...
                                    <div class="spec-value" dir="ltr">{{ $carpetId->width }} <small
                                            class="text-muted">متر</small></div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                <div class="spec-item">
                                    ...
                                    <div class="spec-value" dir="ltr">{{ $carpetId->height }} <small
                                            class="text-muted">متر</small></div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                <div class="spec-item bg-light border-primary-light">
                                    <div class="spec-label text-primary font-weight-bold">مجموع مساحت</div>
                                    <div class="spec-value text-primary" dir="ltr" style="font-size: 1.35rem;">
