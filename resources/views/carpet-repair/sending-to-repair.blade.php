...
<style>
    /* QBCC PREMIUM GLASSMORPHISM THEME */
    :root {
        --qbcc-primary: #1e3a8a;
        --qbcc-secondary: #0ea5e9;
        --qbcc-accent: #f59e0b;
        --qbcc-success: #10b981;
        --qbcc-danger: #ef4444;
        --qbcc-glass-bg: rgba(255, 255, 255, 0.7);
        --qbcc-glass-border: rgba(226, 232, 240, 0.8);
        --radius-xl: 24px;
        --radius-lg: 16px;
        --radius-md: 12px;
    ...
    .pill-qty { background: #e0f2fe; color: #0369a1; }
    .pill-area { background: #ecfdf5; color: #047857; }
</style>
...
<div class="container-fluid premium-container" style="direction: rtl;">
    ...
    <div class="carpet-hero d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
        <div class="d-flex align-items-center gap-4">
            <div class="rounded-circle bg-white text-primary d-flex align-items-center justify-content-center" style="width: 80px; height: 80px; font-size: 2.2rem; font-weight: 900; box-shadow: var(--shadow-premium);">
                <i class="feather icon-scissors" style="color: var(--qbcc-primary);"></i>
            </div>
            <div>
                <h1 class="h2 font-weight-bold text-white mb-2" style="font-family: inherit;">ثبت قالین برای کچایی (ترمیم)</h1>
        ...
        <div class="col-lg-7 mb-4">
            <div class="card glass-card h-100">
                <div class="card-header border-0 bg-transparent pt-4 px-4 pb-0">
                    ...
                    <p class="text-muted small mt-2">لطفاً تیم کچایی (تعمیر کننده) و انبار مقصد برای این قالین را مشخص نمایید.</p>
                </div>
