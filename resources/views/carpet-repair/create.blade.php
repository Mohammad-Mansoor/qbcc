          ...
          <form action="/dashboard/carpet-repair" method="post">
            ...
            <div class="row mb-4">
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" value="{{$id->carpet_no}}" readonly class="form-control custom-input font-weight-bold">
              ...
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" value="{{$id->kachaee->name}}" readonly class="form-control custom-input font-weight-bold">
                  @error('area') <small class="text-danger">{{trans('message.'.$message)}}</small> @enderror
                </div>
              </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" id="area" name="area" value="{{$id->area}}" readonly class="form-control custom-input font-weight-bold text-primary" style="direction: ltr;">
                  @error('area') <small class="text-danger">{{trans('message.'.$message)}}</small> @enderror
                </div>
              </div>
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="number" step="0.01" name="price" placeholder="قیمت" class="form-control custom-input" id="price" value="{{old('price')}}" required>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="date" id="repair-date" name="date" class="form-control custom-input" value="{{old('date', date('Y-m-d'))}}" required>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" name="exchange_rate" id="exchange_rate" value="{{ $currency }}" class="form-control custom-input bg-light" required>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="form-group">
                  ...
                  <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" id="af_total_price" name="af_total_price" readonly class="form-control font-weight-bold text-success" value="{{old('af_total_price')}}" style="direction: ltr; font-size: 1.1rem;">
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" id="total_price" name="total_price" readonly class="form-control font-weight-bold text-success" value="{{old('total_price')}}" style="direction: ltr; font-size: 1.1rem;">
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea name="description" id="description" rows="3" class="form-control custom-input" placeholder="توضیحات مربوط به ترمیم قالین">{{old('description')}}</textarea>
            ...
            <div class="row mt-4">
              <div class="col-lg-12 text-right">
                <button class="btn btn-primary btn-premium shadow-sm" type="submit"><i class="fa fa-save mr-2"></i> ذخیره نهایی و ایجاد سند حسابداری</button>
