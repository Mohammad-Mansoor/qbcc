    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="glass-card">
        <div class="glass-header">
          <h4><i class="fa fa-info-circle text-primary mr-2"></i> مشخصات عمومی ترمیم قالین (Carpet Repair Specifications)</h4>
          <a href="/dashboard/carpet-repair" class="btn btn-light btn-premium shadow-sm"><i class="fa fa-arrow-left mr-2"></i> بازگشت</a>
        </div>
        <div class="card-body p-4">
          
          <div class="row mb-5">
            <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
              <h6 class="form-section-title"><i class="fa fa-diamond mr-2"></i> مشخصات عمومی قالین (Carpet General Specifications)</h6>
                ...
                <table class="detail-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="direction: ltr; font-weight: 600;" class="text-success">{{ $carpet->carpet->area }} m²</td>
                    </tr>
                    <tr>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
              <h6 class="form-section-title"><i class="fa fa-wrench mr-2"></i> مشخصات عمومی ترمیم قالین (Repair General Specifications)</h6>
              <div class="table-responsive">
                <table class="detail-table">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="direction: ltr; font-weight: 600;">{{ number_format($carpet->exchange_rate ?? 1.0, 4) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="text-muted small" style="max-width: 250px; word-wrap: break-word;">{{ $carpet->description ?? 'بدون شرح' }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
