        ...
        <div class="card-body p-4">
          <form action="/dashboard/carpet-repair/{{$carpetRepair->id}}" method="post">
            ...
            <div class="row mb-4">
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" value="{{$carpetRepair->carpet->carpet_no}}" readonly class="form-control custom-input font-weight-bold">
              ...
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" value="{{$carpetRepair->team->name}}" readonly class="form-control custom-input font-weight-bold">
                </div>
              </div>
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  <label class="font-weight-bold text-muted small">کچایی نمبر</label>
                  <input type="text" name="kachaee_number" placeholder="نمبر کچایی" class="form-control custom-input" value="{{$carpetRepair->kachaee_number}}">
              ...
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" id="area" name="area" value="{{$carpetRepair->carpet->area}}" readonly class="form-control custom-input font-weight-bold text-primary" style="direction: ltr;">
                  @error('area') <small class="text-danger">{{trans('message.'.$message)}}</small> @enderror
                </div>
              </div>
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="number" step="any" name="price" value="{{$carpetRepair->price}}" class="form-control custom-input" id="price" required>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="date" name="date" id="repair_date" value="{{$carpetRepair->date}}" class="form-control custom-input">
            ...
            <div class="finance-box shadow-sm">
                <div class="row">
                    <div class="col-lg-12">
                        <h6 class="text-success mb-4 font-weight-bold"><i class="fa fa-money mr-2"></i> تنظیمات عمومی مالی (Global Financial Settings)</h6>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" name="exchange_rate" id="exchange_rate" value="{{ $carpetRepair->exchange_rate ?? $currency }}" class="form-control custom-input bg-light" required>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="form-group">
                ...
                <div class="row mt-3 pt-3 border-top">
                  <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                      <label class="font-weight-bold text-muted small" id="local_total_label">قیمت مجموع (Local Total)</label>
                      <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text bg-light" id="local_total_symbol">؋</span></div>
                        <input type="text" id="af_total_price" name="af_total_price" value="{{$carpetRepair->af_total_price}}" readonly class="form-control font-weight-bold text-success" style="direction: ltr; font-size: 1.1rem;">
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" id="total_price" name="total_price" value="{{$carpetRepair->total_price}}" readonly class="form-control font-weight-bold text-success" style="direction: ltr; font-size: 1.1rem;">
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea name="description" id="description" rows="3" class="form-control custom-input" placeholder="توضیحات مربوط به ترمیم قالین">{{$carpetRepair->description}}</textarea>
            ...
            <div class="row mt-4">
              <div class="col-lg-12 text-right">
                <button class="btn btn-primary btn-premium shadow-sm" type="submit"><i class="fa fa-save mr-2"></i> بروزرسانی و اصلاح سند حسابداری</button>
