...
class RoleController extends Controller
{
    ...
    private function translatePermission($name)
    {
        ...
        $modules = [
            ...
            'create_finishing_work' => 'ایجاد کار کاری (تیاری شده‌ها)',
            'edit_finishing_work' => 'ویرایش کار کاری (تیاری شده‌ها)',
            'finishing_work' => 'کار کاری',
            'the_work' => 'کار',
            ...
            'edit_customer_order_details' => 'ویرایش جزییات سفارش مشتری',
            'delete_customer_order_details' => 'حذف جزییات سفارش مشتری',
            'receive_customer_order_alerts' => 'دریافت هشدارهای سفارش مشتری',
            'assets_accounts' => 'حسابات اجناس',
            'assets_account' => 'حساب اجناس',
            'assets_account_details' => 'جزییات دارایی‌های ثابت',
            'edit_assets_account_details' => 'ویرایش جزییات دارایی‌های ثابت',
            'delete_assets_account_details' => 'حذف جزییات دارایی‌های ثابت',
